...
ui <- 
  navbarPage("Sai Vishnu Kanisetty - Social Network Analysis",
             ...
             tabsetPanel(id = "tabs",
                         tabPanel(
                           ...
                           h6("Q2 and Q3: Browse the files in txt format and visualize any n(user input) connections"),
                           tags$i("Member Summary:"),
                           h6("Q4 and Q5: Compute the number of mails sent by each person"),
                           tags$i("Top Ten Network:"),
                           h6("Q6: Display and Visualize two hop neighbors for top ten Members who sent the mail and top ten who received the mails"),
                           tags$i("Centrality:"),
                           h6("Q7: Display and Visualize the two hop neighbours for top ten Members by centrality in an undirected network"),
                           tags$i("Betweenness Centrality:"),
                           h6("Q8: Display and Visualize the two hop neighbours for top ten Members by betweenness  centrality in an undirected network"),
                           tags$i("Indegree Centrality:"),
                           h6("Q9: Display and Visualize the two hop neighbours for top ten Members by Indegree centrality in a directed network"),
                           tags$i("Department:"),
                           h6("Q10: Display and Visualize the connections between departments"),
                         ...
                         tabPanel(
                           ...
                           sidebarLayout(
                             sidebarPanel(
                               h4("Q2 and Q3: Browse the files in txt format and visualize any n(user input) connections of email-Eu-core.txt"),
                         ...
                         tabPanel(
                           ...
                           sidebarLayout(
                             sidebarPanel(
                               h4("Q4 and Q5: Compute the number of mails sent by each person"),
                         ...
                         tabPanel(
                           ...
                           sidebarLayout(
                             sidebarPanel(
                               h4("Q6: Display and Visualize two hop neighbors for top ten Members who sent the mail and top ten who received the mails"),
                           ...
                           mainPanel(
                             tabsetPanel(type = "tabs",
                                         tabPanel("Data",
                                                  sidebarLayout(
                                                    sidebarPanel(
                                                      h4("Q7: Display and Visualize the two hop neighbours for top ten Members by centrality in an undirected network"),
                           ...
                           mainPanel(
                             tabsetPanel(type = "tabs",
                                         tabPanel("Data",
                                                  sidebarLayout(
                                                    sidebarPanel(
                                                      h4("Q7: Display and Visualize the two hop neighbours for top ten Members by betweenness centrality in an undirected network"),
                                                      h5("This tab has two subtabs - first tab for display first hop and second hop in an undirected network and the second tab for the network display in an undirected network"),
                           ...
                           mainPanel(
                             tabsetPanel(type = "tabs",
                                         tabPanel("Data ",
                                                  sidebarLayout(
                                                    sidebarPanel(
                                                      h4("Q7: Display and Visualize the two hop neighbours for top ten Members by indegree centrality in an undirected network"),
                         ...
                         tabPanel(
                           ...
                           sidebarLayout(
                             sidebarPanel(
                               ...
                               h4("Q10: Display and Visualize the connections between departments"),
